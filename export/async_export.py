    ...
    async def export_sqlite_streaming(
        ...
        try:
            ...
            if sample_records:
                ...
                # Create table
                fields_def = ", ".join(f'"{field}" TEXT' for field in sorted(all_fields))
                ...
                for record in sample_records:
                    values = [record.get(field, None) for field in sorted(all_fields)]
...
"""
    ...
    def get_export_stats(self) -> Dict[str, Any]:
        ...
        successful_exports = sum(1 for exp in self.exports.values() if exp.success)
