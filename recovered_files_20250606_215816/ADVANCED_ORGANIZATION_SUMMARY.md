# 🗂️ Advanced File Organization Summary
Generated: 2025-06-01T20:48:27.896782
Total Scattered Files Found: 320
...
### 📁 Data Exports
- **Files**: 43
- **Location**: `organized_files/data_exports/`

### 📁 Data Files
- **Files**: 65
- **Location**: `organized_files/data_files/`

### 📁 Data Sessions
- **Files**: 13
- **Location**: `organized_files/data_sessions/`

### 📁 Databases
- **Files**: 5
- **Location**: `organized_files/databases/`

### 📁 Documentation
- **Files**: 14
- **Location**: `organized_files/documentation/`

### 📁 Documentation Guides
- **Files**: 11
- **Location**: `organized_files/documentation_guides/`

### 📁 Documentation Reports
- **Files**: 65
- **Location**: `organized_files/documentation_reports/`

### 📁 Miscellaneous
- **Files**: 75
- **Location**: `organized_files/miscellaneous/`

### 📁 Python Analyzers
- **Files**: 2
- **Location**: `organized_files/python_analyzers/`

### 📁 Python Database
- **Files**: 1
- **Location**: `organized_files/python_database/`

### 📁 Python Extractors
- **Files**: 5
- **Location**: `organized_files/python_extractors/`

### 📁 Python Scripts
- **Files**: 17
- **Location**: `organized_files/python_scripts/`

### 📁 Web Files
- **Files**: 4
- **Location**: `organized_files/web_files/`
