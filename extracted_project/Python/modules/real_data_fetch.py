...
def fetch_real_dms(session_file):
    ...
    try:
        ...
        if proxy_manager.test_connection():
            ...
            print("[!] ไม่สามารถเชื่อมต่อ proxy ได้ กำลังลองอีกครั้ง...")
            # ลองใหม่อีกครั้งก่อนยอมแพ้
            if not proxy_manager.test_connection():
                print("[!] proxy ไม่พร้อมใช้งาน กำลังใช้โหมด direct connection...")
                return None
        
        # เรียก API เพื่อดึงข้อมูล DMs
        print("[~] กำลังเรียก Instagram API...")
