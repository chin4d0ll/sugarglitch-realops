        ...
        for root, dirs, files in os.walk(search_folder):
            for file in files:
                ...
                if timestamp_match or date_match:
                    ...
                    base_name = re.sub(r'_\d{10}', '', file)  # Remove timestamp
                    base_name = re.sub(r'_\d{8}_\d{6}', '', base_name)  # Remove date
...
def clean_cache_and_temp():
    ...
    patterns = ["**/__pycache__", "**/*.pyc", "**/*.tmp", "**/*.bak", "**/*.old"]
...
def main():
    ...
    # Generate summary
    print("\n📊 Generating summary...")
    summary = generate_summary(moved_folders, moved_files, removed_reports, cleaned_items, removed_folders)
